// Programa de teste que executa múltiplas instâncias de `hash_persistente` em
...
// o executável `./hash_persistente` via `execvp`.
...
// Cria e executa a tarefa: chama `./hash_persistente lifetime id`
